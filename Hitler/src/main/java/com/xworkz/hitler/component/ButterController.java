...
public class ButterController {
    ...
    public String getButter(ButterDto butterDto) {
        ...
        System.out.println("Butter Name: " + butterDto.getButterName() + " Brand Name: " + butterDto.getBrandName() + " Price: " + butterDto.getPrice() + " Type: " + butterDto.getButterType() + " Fat%: " + butterDto.getFatPercentage());
        return "butter.jsp";
    }
}
